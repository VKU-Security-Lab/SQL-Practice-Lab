<?php
session_start();
if (!isset($_SESSION['currentLevel']) || $_SESSION['currentLevel'] < 2) {
...
<body>
    <h1>Challenge 2</h1>
    <p><b>Mô tả thử thách: </b>Hãy lấy thông tin của người dùng có tên là <b>Harry Potter</b> và có tuổi là <b>21</b></p>
    ...
    <div id="flagDiv">
        ...
        <form action="checkFlag.php" method="post" id="formFlag">
            ...
            <input type="text" id="idChall" name="idChall" hidden value="2">
            <button type="submit">Gửi</button>
        </form>
    </div>

    <form action="challenge2.php" method="post" id="formQuery">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            ...
                            window.location.href = "challenge3.php";
                        } else {
                            alert("Sai rồi");
                        }
                    }
